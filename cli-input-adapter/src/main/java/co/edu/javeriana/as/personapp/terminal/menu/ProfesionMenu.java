...
public class ProfessionMenu {
    ...
    public void startMenu(ProfessionInputAdapterCli professionInputAdapterCli, Scanner keyboard) {
            ...
            try {
                ...
                switch (option) {
                    ...
                    case PERSISTENCE_MARIADB:
                        ...
                        optionsMenu(professionInputAdapterCli, keyboard);
                        break;
    ...
    private void optionsMenu(ProfessionInputAdapterCli professionInputAdapterCli, Scanner keyboard) {
        boolean isValid = false;
        do {
            try {
                showOptionsMenu();
                ...
                switch (option) {
                    ...
                    case OPTION_VIEW_ALL:
                        professionInputAdapterCli.history();
                        break;
                    case OPTION_CREATE:
                        professionInputAdapterCli.create(keyboard);
                        keyboard = new Scanner(System.in);
                        break;
                    case OPTION_EDIT:
                        professionInputAdapterCli.edit(keyboard);
                        keyboard = new Scanner(System.in);
                        break;
                    case OPTION_DELETE:
                        professionInputAdapterCli.delete(keyboard);
                        keyboard = new Scanner(System.in);
                        break;
                    default:
                        log.warn("The chosen option is not valid.");
    ...
    private void showOptionsMenu() {
        System.out.println("----------------------");
        System.out.println(OPTION_VIEW_ALL + " to view all professions");
        System.out.println(OPTION_CREATE + " to create a profession");
        System.out.println(OPTION_EDIT + " to edit a profession");
        System.out.println(OPTION_DELETE + " to delete a profession");
