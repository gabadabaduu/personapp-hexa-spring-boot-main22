...
public class TelefonoMenu {
    ...
    public void iniciarMenu(PhoneInputAdapterCli personaInputAdapterCli, Scanner keyboard) {
    ...
    private void menuOpciones(PhoneInputAdapterCli personaInputAdapterCli, Scanner keyboard) {
        boolean isValid = false;
        do {
            try {
                mostrarMenuOpciones();
